      ...
      <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
        ...
        >
          <div className="flex flex-col gap-4 p-4 md:p-8">
            ...
            <button className="flex justify-center items-center bg-teal-500 hover:bg-teal-600 active:bg-blue-700 focus-visible:ring ring-teal-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 gap-2 px-8 py-3">
              <svg
